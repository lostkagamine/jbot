...
var process = {env: {}};
var console = {};
console.debug = function(m, n) { return (n == undefined) ? logger.debug(m) : logger.debug(m, n);};
console.warn = function(m, n) { return (n == undefined) ? logger.warn(m) : logger.warn(m, n);};
console.log = function(m, n) { return (n == undefined) ? logger.info(m) : logger.info(m, n);};
console.error = function(m, n) { return (n == undefined) ? logger.error(m) : logger.error(m, n);};
console.trace = function(m, n) { return (n == undefined) ? logger.trace(m) : logger.trace(m, n);};
